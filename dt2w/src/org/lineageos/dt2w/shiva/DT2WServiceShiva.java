package org.lineageos.dt2w.shiva;
...
public class DT2WServiceShiva extends Service {
    private static final String TAG = "DT2WServiceShiva";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.shiva.dt2w", dt2wEnabled ? "1" : "0");
        }
